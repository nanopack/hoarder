...
# build hoader
echo "Building HOARDER and uploading it to 's3://tools.nanopack.io/hoader'"
gox -osarch "darwin/amd64 linux/amd64 windows/amd64" -output="./build/{{.OS}}/{{.Arch}}/hoader"
...
aws s3 sync ./build/ s3://tools.nanopack.io/hoader --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers --region us-east-1
